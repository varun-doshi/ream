...
use crate::{
    ...
    fork_choice::helpers::constants::{
        ...
        FAR_FUTURE_EPOCH, GENESIS_EPOCH, GENESIS_SLOT, INACTIVITY_PENALTY_QUOTIENT_ALTAIR,
        ...
        SECONDS_PER_SLOT, SLOTS_PER_EPOCH, SLOTS_PER_HISTORICAL_ROOT, TARGET_COMMITTEE_SIZE,
